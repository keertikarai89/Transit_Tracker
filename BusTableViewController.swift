...
class BusTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
     let busnumber = busnumbers[indexPath.row]
     let cell = tableView.dequeueReusableCell(withIdentifier: busnumber.type.rawValue, for: indexPath)
     
     // Configure the cell...
     cell.textLabel?.text = busnumber.name
        return cell
    }
